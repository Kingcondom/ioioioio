...
> และชุดที่เขียนใหม่ทั้งหมดโดยไม่มีข้อสอบเก่า (**Neuro**, **Mock**) จะไม่มีทั้งสองแท็บนี้
...
| Infectious (5 คาบ) · Neuro (คาบที่เหลือ) · GI (4) · Endocrine (3) · Hemato (3) · Skin (2) · Onco (1) | — | — | ยังไม่ทำ |
