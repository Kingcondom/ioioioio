...
| **Neuro** (คาบ acute ischemic stroke) | **20** (MCQ 18 + MEQ 1 + OSCE/SAQ 1) | — | ✅ คาบแรกเสร็จ — เขียนใหม่จากสไลด์ ยังไม่มีคลังข้อสอบเก่าของระบบนี้ |
...
| **Neuro** | 07 (acute ischemic stroke) | **10** | **20 ข้อ (ครบทุกข้อของคลัง Neuro + ข้อที่เขียนเอง 2 ข้อ)** | 1 / 1 | ✅ คาบแรกเสร็จ — เรียบเรียงจากสไลด์งานประสาทวิทยา รพ.ราชวิถี · **เลขคาบ 07 และวันที่ยังเป็นค่าชั่วคราว ต้องยืนยันกับ MED421-422_Lecture_List.txt** |
